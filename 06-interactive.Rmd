...
NOTE: due to the large volume of data, here we only choose 3 years data (2016-2018) to make Shiny function smoothly.
...
```{r shiny, out.width=800, echo=FALSE}
knitr::include_app("https://wangzhili.shinyapps.io/Collision_bd/", 
  height = "800px")
```
Bonus! Click [Here](https://wangzhili.shinyapps.io/collisions/) to play with a *full screen* Shiny! 